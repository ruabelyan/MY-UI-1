...
const colorsDefaultValues: ColorsThemeConfig = {
  ...
  [getColorKey('primary', 200)]: '#D0D0E5',
  ...
  [getColorKey('secondary2', 600)]: '#4C4AB6',
  [getColorKey('secondary2', 500)]: '#5C5ABF',
  ...
  [getColorKey('neutral', 300)]: '#BFBFBF',
  [getColorKey('neutral', 200)]: '#D9D9D9',
  ...
  [getColorKey('success', 600)]: '#489B1C',
  [getColorKey('success', 500)]: '#4F9E26',
  [getColorKey('success', 400)]: '#5AA831',
  [getColorKey('success', 300)]: '#65B33D',
  [getColorKey('success', 200)]: '#D6F7A9',
